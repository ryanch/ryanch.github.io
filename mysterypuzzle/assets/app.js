...
app.puzzleMetaData = [
    {num:"1", title:"Puz1Name", short:"puzShort Text 1"},
...
app.navItems = [
    {name:app.puzzleMetaData[0].title,  "url":"./puzzle1/index.html" },
    {name:app.puzzleMetaData[1].title,  "url":"./puzzle2/index.html" },
    {name:app.puzzleMetaData[2].title,  "url":"./puzzle3/index.html" },
    {name:app.puzzleMetaData[3].title,  "url":"./puzzle4/index.html" },
    {name:app.puzzleMetaData[4].title,  "url":"./puzzle5/index.html" },
    {name:app.puzzleMetaData[5].title,  "url":"./puzzle6/index.html" },
    {name:app.puzzleMetaData[6].title,  "url":"./puzzle7/index.html" },
    {name:app.puzzleMetaData[7].title,  "url":"./puzzle8/index.html" }
